...
class AstroService {
  ...
  generateOverallForecast(retrogradeInfluence, aspectsInfluence) {
    ...
    // Общая сила влияния
    const strengthScore = (retrogradeInfluence.strength * retroWeight) + 
                          (aspectsInfluence.strength * aspectWeight);
    ...
    const trendScore = (retroTrendScore * retroWeight) + 
                      (aspectTrendScore * aspectWeight);
    ...
    const volatilityScore = (retroVolScore * retroWeight) + 
                           (aspectVolScore * aspectWeight);
