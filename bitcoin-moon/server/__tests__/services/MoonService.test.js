...
describe('MoonService', () => {
  ...
  describe('getPhasesForPeriod', () => {
    it('возвращает фазы луны за период', () => {
      ...
      expect(moonCalculations.getMoonPhasesForPeriod.mock.calls[0][0].toISOString()).toContain('2023-01-01');
      expect(moonCalculations.getMoonPhasesForPeriod.mock.calls[0][1].toISOString()).toContain('2023-01-02');
    });
