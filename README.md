...
![MoonBit Logo](bitcoin-moon/client/public/logo.png)

## Обзор проекта

**MoonBit (Мунбит)** — это инновационная веб-платформа для анализа криптовалют с учетом лунных фаз и астрономических событий. Проект исследует потенциальные корреляции между космическими циклами и движением цены биткоина, предоставляя трейдерам уникальные инсайты для принятия решений.

## ✨ Ключевые возможности

- 📊 **Advanced Charting**: Lightweight Charts с поддержкой infinite scroll и dynamic data loading
- 🔄 **Smart Scaling**: Автоматическая подгрузка данных при изменении visible range
- 📈 **Interactive Analysis**: Плавные переходы между таймфреймами с сохранением масштаба
- 🌙 **Lunar Integration**: Plugin-based система для отображения лунных событий на графике
- 🔍 **Correlation Analysis**: Выявление статистических взаимосвязей между астрономическими и экономическими событиями
- 🌓 **Adaptive Theme**: Темная/светлая тема с автоматической адаптацией к текущей фазе луны
- 📅 **Event Calendar**: Отслеживание предстоящих астрологических и экономических событий
- 🎯 **Resilient Architecture**: Graceful degradation с mock данными при недоступности внешних API
- 🔌 **Plugin System**: Модульная архитектура для расширения функционала
...
- **Графики**: Lightweight Charts v5.0+ с infinite scroll и plugin system
- **Состояние**: React Context API + optimized state patterns
- **Маршрутизация**: React Router v6
- **Работа с датами**: Day.js с timezone support
- **Архитектура**: Atomic Design с BaseChart foundation + Plugin Architecture
